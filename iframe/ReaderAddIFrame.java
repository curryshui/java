...
public class ReaderAddIFrame extends JInternalFrame {
	...
	public ReaderAddIFrame() {
		...
		label_6.setText("valid verification：");
		panel_1.add(label_6);

		comboBox = new JComboBox();
		//comboBoxModel=(DefaultComboBoxModel)comboBox.getModel();
		array=new String[]{"ID","soldier card","student card","worker card"};
		...
		label_9.setText("most borrow amount：");
		panel_1.add(label_9);
