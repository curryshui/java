...
public class BookAddIFrame extends JInternalFrame {
	...
	public BookAddIFrame() {
		...
		setTitle("Add Book Information");						// 设置窗体标题－－－必须
		...
		ISBN = new JTextField("Please input 13 digits",13);
		...
		String[]array=new String[]{"Press","1","2","3"};
	...
	class ISBNFocusListener extends FocusAdapter {
		public void focusLost(FocusEvent e){
			if(!Dao.selectBookInfo(ISBN.getText().trim()).isEmpty()){
				JOptionPane.showMessageDialog(null, "Reduplicate ISBN");
				return;
			}
		}
	}
	...
	class addBookActionListener implements ActionListener {		// 添加按钮的单击事件监听器
		public void actionPerformed(final ActionEvent e) {
			...
			if(ISBN.getText().length()!=13){
				JOptionPane.showMessageDialog(null, "The Number Of ISBN Should Be 13 ");
				return;
			}
