...
public class BookBorrowIFrame extends JInternalFrame {
	...
	private String[] columnNames = { "book isbn", "borrow date", "return date", "reader isbn" };
...
//		});//关闭窗口时候引发的事件
		...
		label_2.setText("amount can borrow：");
		panel_5.add(label_2);
		...
		buttonClear.setText("clear all register");
