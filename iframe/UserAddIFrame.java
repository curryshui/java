...
public class UserAddIFrame extends JInternalFrame {
	...
	public UserAddIFrame() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(arg0.getSource()==button){
					...
					if(textField.getText().length()>12){
						JOptionPane.showMessageDialog(null, "user name must less than 13 bits");
						return;
					}
					...
					if(textField_4.getText().length()==0){
						JOptionPane.showMessageDialog(null, "please input tel");
						return;
					}
					if(textField_4.getText().length()!=11){
						JOptionPane.showMessageDialog(null, "tel must be 11 bits");
						return;
					}
					if(textField_5.getText().length()==0){
						JOptionPane.showMessageDialog(null, "please input cash pledge");
						return;
					}
					...
					if(textField_6.getText().length()>15){
						JOptionPane.showMessageDialog(null, "password must less than 15 bits");
						return;
					}
       ...
       button_1.addActionListener(new CloseActionListener());
		...
		textField_4 = new JTextField("tel number should be 11",11);
