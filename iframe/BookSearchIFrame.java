...
public class BookSearchIFrame extends JInternalFrame {
	 ...
	 * Create the frame
	 */
	String booksearch[] = { "ISBN", "category", "book name", "author", "translator","press",  "publishing date", "price" };
	...
	public BookSearchIFrame() {
		...
		tabbedPane.addTab("conditional enquiry", null, panel_1, null);

		final JPanel panel_1_1 = new JPanel();
		panel_1_1.setBorder(new TitledBorder(null, "please choose enquiry item", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_1_1.setPreferredSize(new Dimension(0, 50));
		panel_1.add(panel_1_1, BorderLayout.NORTH);
         choice=new JComboBox();
		String[] array={"book name","author"};
		...
		panel.setBorder(new TitledBorder(null, "enquiry result", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_1.add(panel);
		...
		tabbedPane.addTab("show all book information", null, panel_2, null);
