...
public class BookBackIFrame extends JInternalFrame {
	...
	public BookBackIFrame() {
		...
		setTitle("Book return manage");
		setBounds(100, 100, 550, 480);

		final JPanel panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "Basic information", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		...
		panel_2.setBorder(new TitledBorder(null, "fine", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel_2.setPreferredSize(new Dimension(250, 230));
		panel_1.add(panel_2);

		final JLabel label_11 = new JLabel();
		label_11.setText("Borrow date：");
		...
		panel_3.setBorder(new TitledBorder(null, "system message", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		...
		buttonback.setText("book return");
	...
	class TableListener extends MouseAdapter {
		public void mouseClicked(final MouseEvent e) {
			...
			if(days3>0){
				...
				ccdays.setText("Not exceed date");
				fkmoney.setText("0");
			}
	...
	class BookBackActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO 自动生成方法存根
			if(readerISBNs==null){
				JOptionPane.showMessageDialog(null, "Please input the reader isbn");
				return;
			}
			System.out.println(bookISBNs==null);

			if(table.getSelectedRow()==-1){
				JOptionPane.showMessageDialog(null, "Please input the book isbn");
				return;	
			}
