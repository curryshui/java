...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	public UserModiAndDelIFrame() {
		...
		textField_4 = new JTextField("tel num should be 11",11);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(textField.getText().length()==0){
					...
					if(textField_4.getText().length()!=11){
						JOptionPane.showMessageDialog(null, "tel num should be 11");
						return;
					}
					if(textField_5.getText().length()==0){
						JOptionPane.showMessageDialog(null, "please input cash plege");
						return;
					}
