...
public class GengGaiMiMa extends JInternalFrame{
	...
	public GengGaiMiMa() {
		...
		label_4.setText("<html>Reminder£ºChange<b> Your Password</b> Only¡£</html>");
			...
			public void actionPerformed(final ActionEvent e) {
				if (oldPass.getText().equals(user.getPassword())) {
					if (newPass1.getText().equals(newPass2.getText())) {
						...
						JOptionPane.showMessageDialog(getContentPane(), "Modify Success¡£");
						doDefaultCloseAction();
					}else {
						JOptionPane.showMessageDialog(getContentPane(), "Not consistent,input again¡£");
					}
				}else {
